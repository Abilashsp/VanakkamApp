      ...
      const renderColorItems = () => {
        return background.map((bg, index) => (
          <View key={index} className="">
            <Text
              className={`${bg.name}  w-7  h-5 text-sm font-medium focus:outline-none  border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700`}
              onPress={() => getcss("bgcolor", bg.name)}
            ></Text>
          </View>
        ));
      };
